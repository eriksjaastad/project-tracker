...
**Purpose:** Local dashboard and CLI for tracking projects, Kanban work, graph relationships, machine designations, and agentic workflow signals across the projects root.
