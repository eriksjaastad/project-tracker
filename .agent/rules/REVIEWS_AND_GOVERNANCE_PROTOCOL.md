<!-- This file used to be auto-synced from project-scaffolding via
     agentsync/sync_governance.py. That sync script was removed when
     project-tracker became self-contained (#6060). Edit this file
     directly; project-scaffolding/REVIEWS_AND_GOVERNANCE_PROTOCOL.md
     is the historical lineage but is no longer the live source of
     truth for project-tracker. -->
